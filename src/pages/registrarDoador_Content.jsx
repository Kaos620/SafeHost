export function ConteudoRegistrarDoador() {
    return (
        <div className="h-auto w-auto p-6 relative">

            <h4 className="RegistrarNovoDoador p-2 flex text-center text-blue-900 text-3xl ">
            Registrar Novo Doador
            </h4>
            <form class="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96 text-center">
