...
import { RegistrarEndereco } from "./registrar_endereco";
import {
    MagnifyingGlassIcon,
    ChevronUpDownIcon,
  ...
  const TABLE_HEAD = ["Doador", "Endereço", "Ultima Entrada", "Editar"];
   
  const TABLE_ROWS = [
    {
      nome: "Rafael Soares Cardoso",
      endereco: "Rua Pernambuco 2485 São Domingos",
      date: "23/04/18",
    },
  ];
          ...
          <div className="mb-8 flex items-center justify-between gap-8">
            ...
            <div className="flex shrink-0 flex-col gap-2 sm:flex-row">
              <RegistrarDoador variant="outlined" size="sm">
                <handleAdicionarDoador/>;
              </RegistrarDoador>
              
              <RegistrarEndereco className="flex items-center gap-3" size="sm"/>
                      ...
                      <td className={classes}>
                        <div className="flex flex-col">
                          <Typography
                            ...
                            className="font-normal"
                          >
                             {editedRows[index]?.endereco || endereco}
                          </Typography>
                        </div>
                      </td>
                      <td className={classes}>
